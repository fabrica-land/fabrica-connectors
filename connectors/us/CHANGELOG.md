...
- **Permanent controllable-electronic-record status (Section 11.1):** The Property Token is a controllable electronic record at all times, including during custody or intermediation; the prior rule that suspended that status inside an Article 8 arrangement is removed. California is expressly designated as the token's jurisdiction under UCC Section 12-107(c)(1)
- **Article 8 recast as coordination (Section 11.3):** When the token is held through a securities intermediary, Article 8 governs the entitlement and Article 12 continues to govern the token; the entitlement holder is the Beneficiary only to the extent of beneficial ownership determined under Section 7
